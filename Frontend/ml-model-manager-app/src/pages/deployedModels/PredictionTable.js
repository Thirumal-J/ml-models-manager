...
const PredictionTable = ({ title, data }) => {
    ...
    async function getPrediction() {
        ...
        formData.append("experiment_id", selectedRow.exp_id);
        formData.append("run_id", selectedRow.run_id);
    ...
    return (
        <>
            ...
            {selectedRow && (
                <Dialog open={open} onClose={handlePredictClose}>
                    ...
                    <DialogContent>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            />
                            <DialogActions>
                                <Button onClick={handlePredictClose} color="primary">
                                    Cancel
                                </Button>
